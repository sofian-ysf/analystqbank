  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#1a1a1a]">
        {/* Header / Navigation */}
        <header className="sticky top-0 z-50 border-b border-[#2a2a2a] bg-[#1a1a1a]/90 backdrop-blur-xl">
          <nav className="mx-auto max-w-[960px] px-4 sm:px-6">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <a href="#product" className="text-[#888] hover:text-white transition-colors">
                  Features
                </a>
                <a href="#pricing" className="text-[#888] hover:text-white transition-colors">
                  Pricing
                </a>
                <a href="#proof" className="text-[#888] hover:text-white transition-colors">
                  Testimonials
                </a>
                <a href="#faq" className="text-[#888] hover:text-white transition-colors">
                  FAQ
                </a>
              </div>
              ...
              <div className="hidden md:flex items-center space-x-4">
                ...
                <Link
                  ...
                  data-section="header"
                  className="bg-[#20b8cd] text-white px-5 py-2 rounded-lg hover:bg-[#1a9fb5] transition-all font-medium"
                >
                  Start Free Trial
                </Link>
              </div>
              ...
              {/* Mobile Menu Button */}
              <button className="md:hidden p-2 rounded-lg text-[#888] hover:text-white hover:bg-[#242424]" aria-label="Open menu">
        ...
        <main>
          ...
          <section id="hero" className="px-4 py-16 sm:py-24 sm:px-6" data-section="hero">
            <div className="mx-auto max-w-[960px]">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    <Link
                      ...
                      data-cta="start_trial"
                      data-section="hero"
                      className="bg-[#20b8cd] text-white px-8 py-3.5 rounded-lg text-base font-medium hover:bg-[#1a9fb5] transition-all text-center"
                    >
                      Start Free Trial
                    </Link>
                    <Link
                      ...
                      data-cta="view_demo"
                      data-section="hero"
                      className="border border-[#3a3a3a] text-white px-8 py-3.5 rounded-lg text-base font-medium hover:bg-[#242424] transition-all text-center"
                    >
                      View Question Bank
                    </Link>
                  </div>

                  <p className="text-sm text-[#666] mb-8">No credit card required. Cancel anytime.</p>

                  {/* Proof Row */}
                  <div className="flex flex-wrap gap-8 text-sm">
                    <div className="flex items-center gap-2">
                      <span className="text-2xl font-semibold text-white">92%</span>
                      <span className="text-[#888]">pass rate</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-2xl font-semibold text-white">3,000+</span>
                      <span className="text-[#888]">candidates passed</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <aside className="bg-[#242424] border border-[#3a3a3a] rounded-xl p-6">
                  <div className="flex items-center gap-2 mb-4 pb-4 border-b border-[#3a3a3a]">
                    <div className="w-3 h-3 rounded-full bg-[#ff5f57]"></div>
                    <div className="w-3 h-3 rounded-full bg-[#febc2e]"></div>
                    <div className="w-3 h-3 rounded-full bg-[#28c840]"></div>
                    <span className="ml-4 text-sm text-[#666]">Question Bank</span>
                  </div>
                  <div className="space-y-3">
                    <div className="bg-[#1a1a1a] rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-[#20b8cd] font-medium">Ethics & Professional Standards</span>
                    ...
                    <div className="bg-[#1a1a1a] rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-[#20b8cd] font-medium">Quantitative Methods</span>
                    ...
                    <div className="bg-[#1a1a1a] rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-[#20b8cd] font-medium">Financial Statement Analysis</span>
                  ...
                  <div className="mt-4 pt-4 border-t border-[#3a3a3a] text-center">
                    <p className="text-sm text-[#666]">Your personalized analytics dashboard</p>
                  </div>
                </aside>
              </div>
            </div>
          ...
          {/* Pain Section */}
          <section id="pain" className="px-4 py-16 sm:px-6 border-t border-[#2a2a2a]" data-section="pain">
            <div className="mx-auto max-w-[960px]">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">£50,000+ Lost Earnings</h3>
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">6-12 Months Career Delay</h3>
                  <p className="text-[#888] text-sm leading-relaxed">
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">Confidence & Reputation Hit</h3>
                  <p className="text-[#888] text-sm leading-relaxed">
          ...
          {/* Product Section */}
          <section id="product" className="px-4 py-16 sm:px-6 border-t border-[#2a2a2a]" data-section="product">
            <div className="mx-auto max-w-[960px]">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  <div className="w-10 h-10 bg-[#20b8cd]/10 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-5 h-5 text-[#20b8cd]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-medium text-white mb-2">Comprehensive Question Bank</h3>
                  <p className="text-[#888] text-sm leading-relaxed">
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">Study Guides & Formula Sheets</h3>
                  <p className="text-[#888] text-sm leading-relaxed">
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6 hover:border-[#4a4a4a] transition-all">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">Realistic Mock Exams</h3>
                  <p className="text-[#888] text-sm leading-relaxed">
          ...
          <section id="proof" className="px-4 py-12 sm:px-6 bg-[#242424] border-y border-[#3a3a3a]" data-section="proof">
            <div className="mx-auto max-w-[960px]">
              <div className="grid grid-cols-2 gap-8 text-center lg:grid-cols-4">
                <div>
                  <div className="text-3xl font-semibold text-white">92%</div>
                  <div className="mt-2 text-[#666] text-sm">Pass rate among engaged users</div>
                </div>
                <div>
                  <div className="text-3xl font-semibold text-white">2,500+</div>
                  <div className="mt-2 text-[#666] text-sm">Exam-style practice questions</div>
                </div>
                <div>
                  <div className="text-3xl font-semibold text-white">3.5x</div>
                  <div className="mt-2 text-[#666] text-sm">Average score improvement</div>
                </div>
                <div>
                  <div className="text-3xl font-semibold text-white">3,000+</div>
                  <div className="mt-2 text-[#666] text-sm">Candidates passed with us</div>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  ...
                  <div className="border-t border-[#3a3a3a] pt-4">
                    <p className="font-medium text-white">Rachel Thompson</p>
                    <p className="text-sm text-[#666]">Investment Analyst, London</p>
                    <p className="text-xs text-[#20b8cd] mt-1">CFA Level I - June 2024</p>
                  </div>
                </div>
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  ...
                  <div className="border-t border-[#3a3a3a] pt-4">
                    <p className="font-medium text-white">James Chen</p>
                    <p className="text-sm text-[#666]">Risk Manager, Singapore</p>
                    <p className="text-xs text-[#20b8cd] mt-1">FRM Part 1 - May 2024</p>
                  </div>
                </div>
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  ...
                  <div className="border-t border-[#3a3a3a] pt-4">
                    <p className="font-medium text-white">Sophie Martinez</p>
                    <p className="text-sm text-[#666]">Portfolio Manager, New York</p>
                    <p className="text-xs text-[#20b8cd] mt-1">CFA Level II - August 2024</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Pricing Section */}
          <section id="pricing" className="px-4 py-16 sm:px-6 border-t border-[#2a2a2a]" data-section="pricing">
            <div className="mx-auto max-w-[960px]">
              <h2 className="text-2xl sm:text-3xl font-semibold text-white text-center mb-4">
              ...
              <div className="grid gap-6 lg:grid-cols-4">
                {/* Trial */}
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  <h3 className="text-lg font-medium text-white mb-2">Trial</h3>
                  <div className="mb-6">
                    <span className="text-3xl font-semibold text-white">Free</span>
                  </div>
                  <ul className="space-y-3 mb-8 text-sm">
                    <li className="flex items-start gap-2 text-[#888]">
                      <svg className="w-4 h-4 text-[#28c840] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <Link
                    ...
                    data-plan="trial"
                    className="block w-full text-center bg-[#20b8cd] text-white px-6 py-2.5 rounded-lg font-medium hover:bg-[#1a9fb5] transition-all"
                  >
                    Start Free Trial
                  </Link>
                </div>
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  ...
                  <button className="w-full border border-[#3a3a3a] text-white px-6 py-2.5 rounded-lg font-medium hover:bg-[#1a1a1a] transition-all">
                    Get Started
                  </button>
                </div>

                {/* Standard - Most Popular */}
                <div className="relative bg-[#242424] border-2 border-[#20b8cd] rounded-lg p-6">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#20b8cd] text-white text-xs font-medium px-3 py-1 rounded">
                    Most Popular
                  </div>
                  <h3 className="text-lg font-medium text-white mb-2">Standard</h3>
                  <div className="mb-6">
                    <span className="text-3xl font-semibold text-white">£599</span>
                    <span className="text-[#666]">/3 months</span>
                  </div>
                  <ul className="space-y-3 mb-8 text-sm">
                    <li className="flex items-start gap-2 text-[#888]">
                      <svg className="w-4 h-4 text-[#28c840] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <button className="w-full bg-[#20b8cd] text-white px-6 py-2.5 rounded-lg font-medium hover:bg-[#1a9fb5] transition-all">
                    Get Started
                  </button>
                </div>
                ...
                <div className="bg-[#242424] border border-[#3a3a3a] rounded-lg p-6">
                  ...
                  <div className="mb-6">
                    <span className="text-3xl font-semibold text-white">£999</span>
                    <span className="text-[#666]">/lifetime</span>
                  </div>
                  <ul className="space-y-3 mb-8 text-sm">
                    <li className="flex items-start gap-2 text-[#888]">
                      <svg className="w-4 h-4 text-[#28c840] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="mt-8 text-center">
                <p className="text-[#888] text-sm">
                  <span className="text-[#28c840] font-medium">Pass Guarantee:</span> Complete 80%+ of questions and all mocks. If you don&apos;t pass, get extended access or a full refund.
                </p>
                <div className="flex justify-center gap-6 mt-4">
                  <span className="text-[#666] text-xs">Secure Payment</span>
                  <span className="text-[#666] text-xs">All Cards Accepted</span>
                  <span className="text-[#666] text-xs">30-Day Money Back</span>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* FAQ Section */}
          <section id="faq" className="px-4 py-16 sm:px-6 border-t border-[#2a2a2a]" data-section="faq">
            <div className="mx-auto max-w-[720px]">
              ...
              <div className="space-y-3">
                <details className="group bg-[#242424] border border-[#3a3a3a] rounded-lg" data-event="faq_open">
                  <summary className="flex cursor-pointer items-center justify-between p-5 font-medium text-white">
                    ...
                    <svg className="w-4 h-4 text-[#666] transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                  <div className="px-5 pb-5 text-[#888] text-sm leading-relaxed">
          ...
          {/* Final CTA Section */}
          <section id="final-cta" className="px-4 py-20 sm:px-6 bg-[#242424] border-t border-[#3a3a3a]" data-section="final-cta">
            <div className="mx-auto max-w-[720px] text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Link
                  ...
                  className="bg-[#20b8cd] text-white px-8 py-3.5 rounded-lg text-base font-medium hover:bg-[#1a9fb5] transition-all"
                >
                  Start Free Trial
                </Link>
                <Link
                  ...
                  data-section="final-cta"
                  className="border border-[#3a3a3a] text-white px-8 py-3.5 rounded-lg text-base font-medium hover:bg-[#1a1a1a] transition-all"
                >
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-[#666]">
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#28c840]" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
        ...
        {/* Footer */}
        <footer className="border-t border-[#2a2a2a] px-4 py-12 sm:px-6">
          <div className="mx-auto max-w-[960px]">
            <div className="grid gap-8 md:grid-cols-4">
              <div>
                <h3 className="mb-4 font-medium text-white">AnalystTrainer</h3>
            ...
            <div className="mt-12 border-t border-[#2a2a2a] pt-8 text-center text-sm text-[#666]">
